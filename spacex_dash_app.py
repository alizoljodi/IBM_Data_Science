...
def get_payload(entered_site):
    if entered_site=='ALL':
        ...
        return fig
    #fig=px.scatter(X=spacex_df.loc[spacex_df['LaunchSite']==entered_site]['PayloadMass'],Y=spacex_df.loc[spacex_df['LaunchSite']==entered_site]['Outcome'])
